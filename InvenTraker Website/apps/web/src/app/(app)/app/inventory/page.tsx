        ...
        actions={
          <div className="flex flex-wrap gap-2">
            <Link
              ...
              className={`${appButtonClass("primary")} ${canCreateInventory ? "" : "pointer-events-none opacity-50"}`}
              aria-disabled={!canCreateInventory}
              tabIndex={canCreateInventory ? 0 : -1}
            >
              Add Item
            </Link>
            <AppButton
      ...
      <AppCard className="mb-4">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            ...
            <p className="secondary-text mt-1">
              Use the dedicated add-item page for full item setup.
            </p>
          </div>
          <Link
            href="/app/inventory/new"
