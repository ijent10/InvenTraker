...
function makeWebsiteId(prefix, index) {
    return `${prefix}_${index + 1}`;
}
function normalizeSections(input, orgName) {
    const defaults = [
        { id: "section_hero", type: "hero", title: orgName, body: "Fresh, local, and ready for your guests.", enabled: true, order: 0 },
        { id: "section_menu", type: "menu", title: "Menu", body: "", enabled: true, order: 1 },
        { id: "section_questionnaire", type: "questionnaire", title: "Request Information", body: "", enabled: true, order: 2 },
        { id: "section_feedback", type: "feedback", title: "Feedback", body: "", enabled: true, order: 3 }
    ];
...
function normalizeWebsiteConfig(input, orgId, orgName, mode) {
