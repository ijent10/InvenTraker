...
## Source of Truth
- Backend only: `./functions/src/recommendation/`
- Primary callables:
...
## Contracts
- Shared schemas: `./packages/shared/src/schemas/recommendations.ts`
- Callable schemas: `./packages/shared/src/schemas/functions.ts`
...
- iOS: `./InstaTracker/Services/RecommendationFallbackService.swift`
- Web: `./apps/web/src/lib/recommendations/fallback.ts`
...
4. Enforce boundaries via:
   - `./scripts/check-single-engine-boundaries.ts`
