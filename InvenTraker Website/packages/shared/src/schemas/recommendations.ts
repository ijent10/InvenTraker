...
export type RecommendationDriver = z.infer<typeof recommendationDriverSchema>
...
export type WasteRiskPrediction = z.infer<typeof wasteRiskPredictionSchema>

export const orderCaseInterpretationSchema = z.enum(["direct_units", "case_rounded"])
export type OrderCaseInterpretation = z.infer<typeof orderCaseInterpretationSchema>
...
export type IngredientDemandRow = z.infer<typeof ingredientDemandRowSchema>
...
export type FrozenPullForecastRow = z.infer<typeof frozenPullForecastRowSchema>
...
export type ProductionPullFactorSummary = z.infer<typeof productionPullFactorSummarySchema>
...
export type RecommendationResponseMeta = z.infer<typeof recommendationResponseMetaSchema>
