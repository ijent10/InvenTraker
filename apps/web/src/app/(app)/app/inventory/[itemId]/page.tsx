...
import { AppButton, AppCard, AppInput, AppSelect, appButtonClass } from "@inventracker/ui"
  ...
  const save = async () => {
    ...
    try {
      ...
      const patch: Partial<ItemRecord> = {
        ...
        defaultExpiration: Math.max(1, Number(form.defaultExpiration || "1")),
        defaultExpirationDays: Math.max(1, Number(form.defaultExpiration || "1")),
        defaultPackedExpiration: Math.max(1, Number(form.defaultPackedExpiration || form.defaultExpiration || "1")),
