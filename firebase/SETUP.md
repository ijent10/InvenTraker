...
This project now supports Firebase Auth + Firestore, with a local fallback when Firebase is not configured.
...
1. Drag `GoogleService-Info.plist` into `/Users/ianjent/Desktop/InvenTracker/InstaTracker/` in Xcode.
2. In the add dialog:
...
2. Install local admin helper deps:
   - `cd /Users/ianjent/Desktop/InvenTracker/firebase`
   - `npm install`
