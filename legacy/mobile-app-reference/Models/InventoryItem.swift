...
struct InventoryCustomField: Codable, Hashable, Identifiable {
    var id: String
    var label: String
    var value: String
...
final class InventoryItem {
    ...
    var pictures: [Data]
    var notes: String = ""
    var restockMaxQuantity: Double = 0
    var customFields: [InventoryCustomField] = []
    ...
    init(
        ...
        self.restockMaxQuantity = max(0, restockMaxQuantity)
